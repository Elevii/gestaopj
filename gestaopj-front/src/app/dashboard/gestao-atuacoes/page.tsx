...
export default function GestaoAtuacoesPage() {
  ...
  }, [atuacoes, filters.dataFim, filters.dataInicio, filters.projetoId, filters.userId]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="flex items-end">
            <button
              type="button"
              onClick={() =>
                setFilters({ projetoId: "", dataInicio: "", dataFim: "", userId: "" })
              }
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-900 dark:text-white">{userName}</p>
                  {user?.email && (
